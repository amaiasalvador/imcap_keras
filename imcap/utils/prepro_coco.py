...
if __name__ == "__main__":
  ...
  parser.add_argument('--output_json', default='/work/asalvador/sat_keras/data/cocotalk_challenge.json', help='output json file')
  parser.add_argument('--output_h5', default='/work/asalvador/sat_keras/data/cocotalk_challenge.h5', help='output h5 file')
  ...
  parser.add_argument('--images_root', default='/seq/segmentation/COCO/tools/images/', help='root location in which images are stored, to be prepended to file_path in input json')
